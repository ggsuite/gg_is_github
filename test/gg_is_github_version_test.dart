...
void main() {
  group('gg_is_github_version.dart', () {
    test('matches the version in pubspec.yaml', () {
      ...
      final file = File('lib/src/gg_is_github_version.dart');
